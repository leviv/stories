...
<style>
  ...
  @keyframes floatAcross {
    0% { transform: translate(var(--start-x), var(--start-y)) rotate(-5deg); }
    33% { transform: translate(calc(var(--start-x) * 0.66 + var(--end-x) * 0.33), calc(var(--start-y) * 0.66 + var(--end-y) * 0.33 + 15vh)) rotate(5deg); }
    66% { transform: translate(calc(var(--start-x) * 0.33 + var(--end-x) * 0.66), calc(var(--start-y) * 0.33 + var(--end-y) * 0.66 - 15vh)) rotate(-2deg); }
    100% { transform: translate(var(--end-x), var(--end-y)) rotate(5deg); }
  }
</style>
