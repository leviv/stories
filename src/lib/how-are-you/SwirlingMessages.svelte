	...
	$: {
		displayItems = messages.map((text, i) => {
			...
			return {
				...
				delay: -(Math.random() * 60), // Negative delay starts animation immediately mid-way
...
<div
	class="swirl-container"
	style="--bubble-img: url('{base}/messages/message-bubbles/right-bubble-light.svg')"
>
